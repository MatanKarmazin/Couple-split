...
export function BalanceCard({ balanceMinor, currency = "ILS" }: { balanceMinor: number; currency?: CurrencyCode }) {
    ...
    <Card className="min-w-0 overflow-hidden bg-text text-surface">
      <div className="flex min-w-0 items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-2 break-words text-2xl font-bold sm:text-3xl">{formatMoney(Math.abs(balanceMinor), currency, locale)}</p>
